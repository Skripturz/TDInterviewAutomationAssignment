...
public class CSV_reader {
	...
	static String CSVfile = System.getProperty("user.dir")+File.separator+"src"+File.separator+"test"+File.separator+"resources"+File.separator+"TestData"+File.separator+"SampleCsv2.csv";
	public CSV_reader(File file) {
		this.file=file;
	}
	...
	public static void main(String arg[]) {
		System.out.println("output>>>"+CSV_reader.getUserTypeDetails("newCustomerNotPreapproved","gender"));
	}
}
